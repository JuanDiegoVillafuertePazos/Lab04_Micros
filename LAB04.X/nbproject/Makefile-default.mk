...
SOURCEFILES_QUOTED_IF_SPACED=doble7seg.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/doble7seg.o
POSSIBLE_DEPFILES=${OBJECTDIR}/doble7seg.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/doble7seg.o

# Source Files
SOURCEFILES=doble7seg.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/doble7seg.o: doble7seg.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/doble7seg.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/doble7seg.o \
	doble7seg.s \
